...
public class StudentOperation implements StudentInterface {
	...
	@Override
	public String registerStudent(String userName, String phoneNumber, String address, String userId, String password,
			String role, String rollNumber, String branch, Boolean isVerified) throws UserAlreadyExistException {
		// TODO Auto-generated method stub
		String studentId;
		try {

			Student newStudent = new Student(userName, phoneNumber, address, userId, password, role, rollNumber, branch,
					isVerified);
